...
//                        .invalidateHttpSession(true))
                ...
                .authorizeHttpRequests((authorizeHttpRequests) -> authorizeHttpRequests
                        .requestMatchers("/api/auth/signup","/api/auth/duplicate","/api/auth/reissue","/api/transfer/download","/api/chat/message/messages/**","/app/**","/ws/**","/api/chat/message/download").permitAll()
