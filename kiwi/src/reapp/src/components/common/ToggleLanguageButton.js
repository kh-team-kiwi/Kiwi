...
const ToggleLanguageButton = () => {
    ...
    return (
        ...
        {languageOptionsVisible && (
                <div className='toggle-language-list'>
                    <div onClick={() => changeLanguage('ko')} className={selectedLanguage === 'ko' ? 'toggle-language-selected' : ''}>한국어</div>
                    <div onClick={() => changeLanguage('en')} className={selectedLanguage === 'en' ? 'toggle-language-selected' : ''}>English</div>
                    <div onClick={() => changeLanguage('es')} className={selectedLanguage === 'es' ? 'toggle-language-selected' : ''}>Español</div>
                    <div onClick={() => changeLanguage('fr')} className={selectedLanguage === 'fr' ? 'toggle-language-selected' : ''}>Français</div>
                    <div onClick={() => changeLanguage('de')} className={selectedLanguage === 'de' ? 'toggle-language-selected' : ''}>Deutsch</div>
                    <div onClick={() => changeLanguage('ja')} className={selectedLanguage === 'ja' ? 'toggle-language-selected' : ''}>日本語</div>
                    <div onClick={() => changeLanguage('zh')} className={selectedLanguage === 'zh' ? 'toggle-language-selected' : ''}>中文</div>
                </div>
            )}
        </div>
