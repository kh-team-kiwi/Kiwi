...
const Header = () => {
  ...
  return (
    <header className='header-container'>
      ...
      <div className={`header-page-settings-container ${activePage === 'teamsettings' ? 'active' : 'inactive'}`} onClick={() => handleClick('teamsettings/personal-manage')}>
