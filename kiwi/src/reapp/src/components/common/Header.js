...
const Header = () => {
  ...
  return (
    <header className='header-container'>
      ...
      <div className={`header-page-icon-container ${activePage === 'calendar' ? 'active' : ''}`} onClick={() => handleClick('calendar')}>
      ...
      <div className={`header-page-icon-container ${activePage === 'drive' ? 'active' : ''}`} onClick={() => handleClick('drive')}>
      ...
      <div className={`header-page-icon-container ${activePage === 'documents' ? 'active' : ''}`} onClick={() => handleClick('documents')}>
      ...
      <div className={`header-page-icon-container ${activePage === 'teamsettings' ? 'active' : ''}`} onClick={() => handleClick('teamsettings')}>
