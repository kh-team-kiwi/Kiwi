...
const Header = () => {
  ...
  return (
    <header className='header'>
        ...
        <Link to="/documents">
            <div className={`page-icon-container ${activePage === 'documents' ? 'active' : ''}`} onClick={() => handleClick('documents')}>
            <svg className='page-icon' xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="white" class="bi bi-file-earmark-text-fill" viewBox="0 0 16 16">
