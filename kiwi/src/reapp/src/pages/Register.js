        ...
        <div className={`register-container ${initialLoad ? 'flick-down' : ''} ${isAnimating ? 'flick-up' : ''}`}>
            <form onSubmit={handleSubmit}>
                ...
                <div className='register-input-container' >
                    ...
                    <input className="register-name-input" type="text" id="memberNickname" name="memberNickname" placeholder={t('name')} value={formData.memberNickname}
                ...
                <div className='register-input-container' >
                    ...
                    <input className="register-password-input"  type="password" id="memberPwd" name="memberPwd" placeholder={t('password')} value={formData.memberPwd}
                           onChange={handleChange} required/>
                </div>
                <div className='register-input-container' >
                    <div className="register-icon-container" >
                    ...
                    <input className="register-id-input" type="password" id="confirmPwd" name="confirmPwd" placeholder={t('confirm-password')} value={formData.confirmPwd}
                           onChange={handleChange} required/>
                </div>
            ...
            <div className="already-have-account">
                <Link to="#" onClick={handleLoginClick}>{t('already-have-an-account')}</Link>
            </div>
        </div>
